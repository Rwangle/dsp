...
ls to see if you are in the new directory
...
why.
output went into the test file. notto standard output, so we dont see it. 
...
adds letters to represent filesize more accurately
